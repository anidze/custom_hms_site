  ...
  try {
    ...
    if (guestId) {
      await pool
        ...
        .input("full_name", sql.NVarChar(sql.MAX), `${firstName} ${lastName}`.trim())
        .input("first_name", sql.NVarChar(sql.MAX), firstName || null)
        .input("last_name", sql.NVarChar(sql.MAX), lastName || null)
        .input("gender", sql.NVarChar(sql.MAX), gender || null)
        ...
        .input("country", sql.NVarChar(sql.MAX), country || null)
        .input("zip_code", sql.NVarChar(sql.MAX), postal || null)
        .input("notes", sql.NVarChar(sql.MAX), addressNotes)
        .query(`
          UPDATE guests SET
